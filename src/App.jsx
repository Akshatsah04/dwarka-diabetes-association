...
const teamData = {
  founders: [
    {
      name: 'Dr. S. K. Gupta',
      role: 'Chief Diabetologist & Founder President',
      qualifications: 'MD, DM (Endocrinology) - AIIMS',
      avatar: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=400&h=400',
    },
    {
      name: 'Dr. Ramesh Verma',
      role: 'Senior Endocrinologist & Co-Founder',
      qualifications: 'MD, F.R.C.P. (Endo) - London',
  ...
  patrons: [
    {
      ...
      role: 'Honorary Advisor & Medical Patron',
      qualifications: 'Ex-Director, National Institute of Health',
    ...
    },
    {
      ...
      role: 'Senior Pediatrician & Life Patron',
      qualifications: 'MD (Pediatrics), Diabetes Educator',
      avatar: 'https://images.unsplash.com/photo-1594824813573-246434de83fb?auto=format&fit=crop&q=80&w=400&h=400',
    }
  ],
  executives: [
    {
      ...
      qualifications: 'Social Welfare & Health Advocate',
      avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400&h=400',
    },
    {
      name: 'Mrs. Sunita Rao',
      role: 'Treasurer & Public Relations',
      qualifications: 'MHA (Healthcare Administration)',
    ...
    },
    {
      ...
      qualifications: 'BAMS, Diabetes Management Specialist',
...
const galleryImages = [
  {
    id: 1,
    url: '/camp_1.png',
    title: 'Free Sugar Testing & Screening Camp',
    description: 'DDA organized a community screening camp in Dwarka Sector 10 where over 450 residents received complimentary HbA1c tests, consultations, and counseling services.'
  },
  {
    id: 2,
    url: '/camp_2.png',
    title: 'Diabetes Awareness & Prevention Seminar',
    description: 'Interactive session hosted by senior endocrinologists on healthy eating habits, lifestyle changes, and the reverse-diabetes paradigm.'
  },
  {
    id: 3,
    url: '/camp_3.png',
    title: 'Senior Citizens Walkathon & Wellness Drive',
    description: 'Promoting active living and community support, our annual walkathon brought together hundreds of active elders advocating for metabolic health.'
  },
  {
    id: 4,
    url: '/camp_4.png',
    title: 'Youth Diabetes & Obesity Awareness Campaign',
    description: 'A special outreach drive targeting local colleges to educate the next generation about the rising impact of insulin resistance and lifestyle choices.'
  }
];
    ...
    <div className="relative min-h-screen font-sans selection:bg-medical-500 selection:text-white bg-navy-50">
        ...
        {loading && (
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              />
              <div className="relative p-4 bg-white rounded-full text-medical-600 shadow-2xl">
                <Activity className="w-10 h-10 animate-pulse text-medical-500" />
              </div>
            </div>
            <motion.h2 
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="flex items-center justify-center p-2 rounded-xl bg-medical-500 text-white shadow-lg shadow-medical-500/30 group-hover:scale-105 transition-transform duration-300">
            ...
            <nav className="hidden md:flex items-center gap-1">
              {['home', 'about', 'gallery', 'team', 'mission', 'contact'].map((section) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-semibold rounded-xl capitalize tracking-wide transition-all duration-300 relative ${
              ...
              <div className="px-4 pt-2 pb-6 space-y-1">
                {['home', 'about', 'gallery', 'team', 'mission', 'contact'].map((section) => (
                  <button
                    key={section}
                    onClick={() => handleNavClick(section)}
                    className={`block w-full text-left px-4 py-3 rounded-xl text-base font-semibold capitalize transition-all duration-300 ${
                      activeSection === section 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <h4 className="text-2xl font-bold text-navy-900">
                Spreading Awareness, Healing Lives, Strengthening Families.
              </h4>
              <p className="text-navy-600 leading-relaxed text-base">
                Dwarka Diabetes Association (DDA) is a registered medical advocacy and community wellness initiative. Driven by a dedicated panel of senior diabetologists, lifestyle coach coordinators, and social workers, we strive to bring world-class metabolic health awareness right to your doorstep.
              </p>
              <p className="text-navy-600 leading-relaxed text-base">
                Diabetes is not just a clinical diagnosis; it is an everyday battle against silent lifestyle stressors. We believe that with precise clinical education, regular physical screening, and emotional encouragement, we can curb insulin resistance and support individuals to live healthy, medication-free lives.
              </p>

              {/* Check features list */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                {[
                  'Free sugar testing camps',
                  'Diet & nutrition counseling',
                  'Life patron doctor consults',
                  'Youth obesity awareness',
                  'Elderly fitness counseling',
                  'Complication prevention drives'
                ].map((item, idx) => (
                  <div key={idx} className="flex items-center gap-3 text-navy-700">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-medical-100 flex items-center justify-center text-medical-600 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {galleryImages.map((image) => (
              <motion.div
                ...
                className="group relative cursor-pointer overflow-hidden rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 aspect-[4/3] border border-navy-100"
              >
                <img 
                  src={image.url} 
                  alt={image.title} 
                ...
                {/* Overlay details */}
                <div className="absolute inset-0 bg-gradient-to-t from-navy-950/90 via-navy-950/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <h4 className="text-white text-sm sm:text-base font-bold leading-snug">
                    {image.title}
                  </h4>
                  <p className="text-skycare-200 text-xxs sm:text-xs mt-1 font-medium line-clamp-2">
                    {image.description}
                  </p>
                  <div className="text-white flex items-center gap-1 text-[10px] mt-3 uppercase tracking-wider font-bold text-medical-300">
                    View Closer <ChevronRight className="w-3. h-3" />
                  </div>
                </div>

                {/* Corner Camp Tag */}
                <div className="absolute top-3 left-3 bg-white/80 backdrop-blur-sm text-navy-800 text-[10px] font-bold tracking-wider px-3 py-1 rounded-full border border-navy-100">
                  HEALTH EVENT
                </div>
              </motion.div>
            ))}
      ...
      <section id="team" className="py-20 sm:py-28 relative bg-navy-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* Subsections: Founders, Patrons, Executives */}
          {['founders', 'patrons', 'executives'].map((roleKey, idx) => {
            ...
            return (
              <div key={roleKey} className={idx > 0 ? 'mt-16 md:mt-24' : ''}>
                ...
                {/* Team cards grid */}
                <div className={`grid grid-cols-1 sm:grid-cols-2 ${roleKey === 'executives' ? 'lg:grid-cols-3' : 'lg:grid-cols-2 max-w-4xl'} gap-8`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-gradient-to-tr from-navy-900 via-navy-900 to-navy-950 rounded-[2.5rem] p-8 sm:p-16 text-center text-white relative overflow-hidden shadow-2xl border border-white/5">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold leading-relaxed mb-10 max-w-3xl">
                "Our mission is to promote diabetes awareness, encourage early diagnosis, and support individuals through education and community initiatives."
              </p>

              <div className="w-24 h-0.5 bg-medical-500/50 mb-10" />

              {/* Three Core Pillars with Icons */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                {[
                  {
                    icon: <Activity className="w-6 h-6" />,
                    title: 'Prevention first',
                    desc: 'Encouraging daily wellness, balanced dieting, and simple lifestyle shifts to counter insulin resistance before it sets in.'
                  },
                  {
                    icon: <Calendar className="w-6 h-6" />,
                    title: 'Early Screening',
                    desc: 'Running systematic weekly screening camps across Dwarka to detect metabolic changes and pre-diabetes early.'
                  },
                  {
                    icon: <Users className="w-6 h-6" />,
                    title: 'Support Network',
                    desc: 'Building patient education cohorts to provide constant counseling, clinical guidance, and therapeutic encouragement.'
                  }
                ].map((pillar, idx) => (
                  <motion.div
                    key={idx}
                    ...
                    className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm flex flex-col items-center"
                  >
                    ...
                    <p className="text-xs text-navy-300 leading-relaxed text-center">{pillar.desc}</p>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-md border border-navy-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-navy-600 leading-relaxed">
                    ...
                    Plot 12, Wellness Sector 12, Dwarka,<br />
              ...
              <div className="rounded-3xl overflow-hidden shadow-md border border-navy-100 relative group aspect-[4/3] bg-navy-200">
                ...
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14013.914264627192!2d77.04412455541991!3d28.585429100000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1ac08560bbbf%3A0xc3b8390b14620f44!2sDwarka%2C%20New%20Delhi%2C%20Delhi!5e0!3m2!1sen!2sin!4v1716660000000!5m2!1sen!2sin" 
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full px-4 py-3.5 rounded-xl bg-navy-50 border ${
                          formErrors.name ? 'border-red-500 focus:ring-red-400' : 'border-navy-200 focus:border-medical-500 focus:ring-medical-400/20'
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3.5 rounded-xl bg-navy-50 border ${
                          formErrors.email ? 'border-red-500 focus:ring-red-400' : 'border-navy-200 focus:border-medical-500 focus:ring-medical-400/20'
                        } text-sm focus:outline-none focus:ring-4 transition-all`}
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3.5 rounded-xl bg-navy-50 border ${
                        formErrors.phone ? 'border-red-500 focus:ring-red-400' : 'border-navy-200 focus:border-medical-500 focus:ring-medical-400/20'
                      } text-sm focus:outline-none focus:ring-4 transition-all`}
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3.5 rounded-xl bg-navy-50 border ${
                        formErrors.message ? 'border-red-500 focus:ring-red-400' : 'border-navy-200 focus:border-medical-500 focus:ring-medical-400/20'
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 pb-12 border-b border-white/10">
            ...
            <div className="md:col-span-5 space-y-4">
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center p-2 rounded-xl bg-medical-500 text-white shadow-lg shadow-medical-500/35">
                  <Activity className="w-6 h-6" />
                </div>
            ...
            <div className="md:col-span-4 space-y-4">
              ...
              <div className="space-y-3 text-sm text-navy-300">
                <p className="flex items-start gap-2.5">
                  <MapPin className="w-5 h-5 text-medical-400 flex-shrink-0" />
